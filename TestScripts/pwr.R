...
## 29 second order and 108 third order. Tag labels have been applied to all basic component events.
##
...
pwr<-addProbability(pwr, at=24, prob=1e-4, tag="G3B", name="Bleed Air To", name2="G3 Fails")
